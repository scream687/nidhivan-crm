...
import { Flame, Phone, Clock, MapPin, Copy } from "lucide-react";
import {
  cn,
  STAGE_COLORS,
  SOURCE_COLORS,
    ...
    >
      <div className="flex items-start justify-between gap-2 mb-2">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5">
            ...
            {lead.isDuplicate && (
              <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-orange-100 text-orange-600 font-medium flex items-center gap-0.5 flex-shrink-0">
                <Copy size={10} />
                Dup
              </span>
            )}
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          {lead.assignedTo && (
            <div
              className="w-5 h-5 rounded-full bg-blue-200 flex items-center justify-center text-blue-700 text-[10px] font-semibold"
