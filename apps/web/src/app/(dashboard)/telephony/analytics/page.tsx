    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <TrendingUp size={20} className="text-[#E04020]" />
          <h1 className="text-xl font-bold text-[#111113] tracking-tight">Call Analytics</h1>
        </div>
      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-3 gap-4">
            {[
              { label: 'Total Calls', value: totalCalls.toLocaleString(), color: 'bg-[#FDECE6] text-[#E04020]' },
